      ...
      >
        <div className="container text-center">
          ...
          <p className="lead mx-auto" style={{ maxWidth: 700 }}>
            Pyxis Discovery supports computational modeling, virtual docking and bioavailability optimization using an array of commercial and proprietary computational tools.
          </p>
        </div>
      </section>
