# Rollback Guide (OPS-04) — Bun→Node / Docker only

> **Archived 2026-08-22.** Not the production rollback. Live product ops:
> [`../POST-PROMOTION-HANDOFF.md`](../POST-PROMOTION-HANDOFF.md), port swap in
> [`../ARRIVAL-RUNBOOK.md`](../ARRIVAL-RUNBOOK.md) §8 (on **`84`**).
>
> ## ⚠ This is the *Bun→Node* / Docker rollback. It is not the production rollback.
>
> **Production does not run Docker.** Public site is on **`84.13.81.51`** (legacy Vite
> `:5173`); `83` is imminent shutdown. Nothing below applies to live Pyxis.
>
